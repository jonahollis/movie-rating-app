...
const ReviewForm = ({ addReview, onRate }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    addReview(author, reviewText, rating);
    setAuthor('');
    setReviewText('');
    setRating(0);
  };
  ...
  return (
    <div>
        <Rating rating={rating} setRating={setRating} onRate={onRate}/>
